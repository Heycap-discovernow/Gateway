...
exports.VerifyCodeForgotPasswordController = void 0;
...
let VerifyCodeForgotPasswordController = class VerifyCodeForgotPasswordController {
    constructor(client) {
        this.client = client;
    }
    async verifyCode(code, token, res) {
        try {
            const result = await (0, rxjs_1.lastValueFrom)(this.client.send('forgot-verify-code', code));
            if (!result) {
...
exports.VerifyCodeForgotPasswordController = VerifyCodeForgotPasswordController;
__decorate([
    (0, common_1.UseGuards)(AccesTokenAuthGuard_1.AccessTokenAuthGuard),
    (0, common_1.Post)("/forgotpassword/code"),
...
], VerifyCodeForgotPasswordController.prototype, "verifyCode", null);
exports.VerifyCodeForgotPasswordController = VerifyCodeForgotPasswordController = __decorate([
    (0, common_1.Controller)("/users"),
    __param(0, (0, common_1.Inject)('USERS_TRANSPORT')),
    __metadata("design:paramtypes", [microservices_1.ClientProxy])
], VerifyCodeForgotPasswordController);
//# sourceMappingURL=VerifyCodeForgotPasswordController.js.map