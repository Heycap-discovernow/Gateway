...
let DeleteUserController = class DeleteUserController {
    ...
    async deleteUser(accessToken, res) {
        try {
            const result = await (0, rxjs_1.lastValueFrom)(this.client.send('delete-user', accessToken));
            if (!result) {
                throw new microservices_1.RpcException('User not deleted');
            }
...
__decorate([
    ...
    (0, common_1.Delete)("/"),
    __param(0, (0, AccessToken_1.AccessToken)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], DeleteUserController.prototype, "deleteUser", null);
