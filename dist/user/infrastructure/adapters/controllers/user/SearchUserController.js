...
let SearchUserController = class SearchUserController {
    constructor(client) {
        this.client = client;
    }
    async searchUser(text, res) {
        try {
            const result = await (0, rxjs_1.lastValueFrom)(this.client.send('search-user', text));
            if (!result) {
...
], SearchUserController.prototype, "searchUser", null);
exports.SearchUserController = SearchUserController = __decorate([
