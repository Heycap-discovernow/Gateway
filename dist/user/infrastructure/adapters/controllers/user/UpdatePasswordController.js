...
let UpdatePasswordController = class UpdatePasswordController {
    ...
    async updatePassword(password, accessToken, res) {
        try {
            const result = await (0, rxjs_1.lastValueFrom)(this.client.send('update-password', { token: accessToken, newPassword: password }));
            if (!result) {
...
exports.UpdatePasswordController = UpdatePasswordController = __decorate([
    (0, common_1.Controller)("/users"),
    __param(0, (0, common_1.Inject)('USERS_TRANSPORT')),
    __metadata("design:paramtypes", [microservices_1.ClientProxy])
], UpdatePasswordController);
//# sourceMappingURL=UpdatePasswordController.js.map